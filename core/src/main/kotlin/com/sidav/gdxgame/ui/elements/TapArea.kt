...
open class TapArea(
    ...
    fun drawText(batch: SpriteBatch, layout: GlyphLayout, font: BitmapFont, yOffset: Float = 0f, textOverride: String? = null) {
        textOverride?.let {
            drawWrappedText(
                textOverride, rect.x, rect.y + rect.height - yOffset, rect.width,
    ...
    @Deprecated("Use hitByTap instead")
